...
io.prependIntoElement = function(value, id){
  document.getElementById(id).innerHTML = value + "<br>" + document.getElementById(id).innerHTML;
}

io.report = function(value){
  io.prependIntoElement(value, "reports");
}
...
io.showSlider = function(name){
  io.showElement(name + "Slider");
  io.showElement(name + "SliderRange");
  io.showElement(name + "SliderIn");
  io.showElement(name + "SliderOut");
}

io.hideSlider = function(name){
  //console.log(name + "Slider")
  io.hideElement(name + "Slider");
  //console.log(2)
  io.hideElement(name + "SliderRange");
  //console.log(1)
  io.hideElement(name + "SliderIn");
  //console.log(1)
  io.hideElement(name + "SliderOut");
}